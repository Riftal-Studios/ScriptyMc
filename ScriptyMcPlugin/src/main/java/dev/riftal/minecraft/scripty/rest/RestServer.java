...
public class RestServer {
    ...
    private String initializeApiKey() {
        ...
        plugin.getLogger()
                .info("This key is required for all API requests. Please save it securely.");
    ...
    private void registerEndpoints(ApiKeyFilter apiKeyFilter) {
        ...
        HttpContext spawnContext = server.createContext("/api/spawn",
                new SpawnEntityHandler(plugin));
        HttpContext blockContext = server.createContext("/api/block",
                new PlaceBlockHandler(plugin));
